...
int main(int argc, char** argv)
{
	...
	graph.addEdge(1, 0, 10.0f);
	graph.addEdge(1, 2, 35.0f);
	graph.addEdge(1, 3, 25.0f);
	graph.addEdge(2, 0, 15.0f);
	graph.addEdge(2, 1, 35.0f);
	graph.addEdge(2, 3, 30.0f);
	graph.addEdge(3, 0, 20.0f);
	graph.addEdge(3, 1, 25.0f);
	...
	glutCreateWindow("Muhammad Farkhan Maulana / 2000018280 - POSTEST 8 PRAKTIKUM STIMA");
